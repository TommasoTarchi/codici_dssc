/* in this code we show how to avoid data race in for loops using the
 * 'reduction' clause; the same result could be achieved using 'atomic'
 * (for example 'atomic update'), but it would be far less efficient */
