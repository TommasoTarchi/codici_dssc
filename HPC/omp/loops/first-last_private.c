/* here some examples of using 'first private' and 'last private' clauses with 
 * parallel for loops
 *
 * remember that 'last private' clause can be used ONLY with parallel for loops,
 * never with simple parallel regions */
