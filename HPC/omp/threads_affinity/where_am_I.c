/* this program shows where the requested threads are located 
 *
 * NOTICE: in the output 'core' refers to the HWthread (maybe, TO BE 
 * CLARIFIED)
 *
 * PLACES and BIND (binding policy) can be set both directly exporting 
 * the environment variables (OMP_PLACES and OMP_PROC_BINDING) and using 
 * the default functions for that */
