/* shows memory organization in an openMP code */

/* notice that the stacks are mapped contiguously and that the stack of the master
 * thread is much larger than the others (which are all of equal size) */
