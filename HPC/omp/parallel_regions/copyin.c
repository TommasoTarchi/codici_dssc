/* example of using copyin attribute for parallel regions: it propagates the values
 * previously passed to threadprivate from the master to all the other threads */
