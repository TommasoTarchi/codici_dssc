/* we compare time for accessing stack and heap using and not using
 * pointers */

/* notice that timings are all comparable */
...
int access_the_stack_dp( void )
{
  ...
  printf("timing for accessing the stack by pointer was: %g (sigma: %g)\n\n", time, std_dev);
...
int access_the_heap_dp ( void )
{
  ...
  printf("timing for accessing the heap with reduced ptr arithmetic was: %g (sigma: %g)\n\n", time, std_dev);
